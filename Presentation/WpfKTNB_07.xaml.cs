...
namespace Presentation
{
    ...
    /// </summary>
    public partial class WpfKTNB_07 : Window
    {
        public WpfKTNB_07()
        {
        ...
        private void btnOk_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                bien[4] = "@KyBC";
                giatri[4] = KyBC;
                var _dt = cls.LoadDataProcPara("usp_UpKTNB07", bien, giatri, thamso);
                rpt_KTNB_07 rpt = new rpt_KTNB_07();
