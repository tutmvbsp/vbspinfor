...
namespace Presentation
{
    ...
    /// </summary>
    public partial class WpfKTNB_05 : Window
    {
        public WpfKTNB_05()
        {
        ...
        private void btnOk_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                bien[4] = "@KyBC";
                giatri[4] = KyBC;
                var _dt = cls.LoadDataProcPara("usp_UpKTNB05", bien, giatri, thamso);
                rpt_KTNB_05 rpt = new rpt_KTNB_05();
