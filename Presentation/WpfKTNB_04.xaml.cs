...
namespace Presentation
{
    ...
    /// </summary>
    public partial class WpfKTNB_04 : Window
    {
        public WpfKTNB_04()
        {
        ...
        private void btnOk_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                bien[4] = "@KyBC";
                giatri[4] = KyBC;
                var _dt = cls.LoadDataProcPara("usp_UpKTNB04", bien, giatri, thamso);
                rpt_KTNB_04 rpt = new rpt_KTNB_04();
