...
namespace Presentation
{
    ...
    /// </summary>
    public partial class WpfPhanLoaiKH
    {
        public WpfPhanLoaiKH()
        {
            InitializeComponent();
        }
        ...
        private void Window_Loaded(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                //var dtNgnhan = cls.LoadDataText("select * from NG_NHAN");
                //DataColumn column = new DataColumn("MA", typeof(int));
                //dtNgnhan.Columns.Add(column);

                //DataRow newRow = dtNgnhan.NewRow();
                //newRow["MA"] = 1;

                //dtNgnhan.Rows.Add(newRow);

                //dgvData.Columns.Add(GetNewComboBoxColumn("Nguyên nhân", "MA", dtNgnhan));

                //this.DataContext = dtNgnhan;
            }
            catch (Exception ex)
            {
        ...
        private void LblGetData_OnMouseDown(object sender, MouseButtonEventArgs e)
        {
            ...
            try
            {
                ...
                bien[2] = "@MaTo";
                giatri[2] = s.Left(CboTo.SelectedValue.ToString().Trim(), 7);
                dt = cls.LoadDataProcPara("usp_PhanLoaiKH", bien, giatri, thamso);
    ...
    //-------------------------------
        ...
        private void Save()
        {
            try
            {
                ...
                //}
                MessageBox.Show("Sr. chương trình chưa hoàn thiện!", "Mess", MessageBoxButton.OK, MessageBoxImage.Warning);
            }
            catch (Exception ex)
            {
