...
namespace Presentation
{
    ...
    /// </summary>
    public partial class WpfKTNB_02 : Window
    {
        public WpfKTNB_02()
        {
        ...
        private void btnOk_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                bien[4] = "@KyBC";
                giatri[4] = KyBC;
                var _dt = cls.LoadDataProcPara("usp_UpKTNB02", bien, giatri, thamso);
                rpt_KTNB_02 rpt = new rpt_KTNB_02();
