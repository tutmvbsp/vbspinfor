...
namespace Presentation
{
    ...
    /// </summary>
    public partial class WpfKTNB_01 : Window
    {
        public WpfKTNB_01()
        {
        ...
        private void btnOk_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                if (KyBC == "1")
                {
                    foreach (DataRow dr in dt.Rows)
                    {
                        string strup = "update LUUKTNB01 set COT3='" + dr["COT3"] + "',COT4='" + dr["COT4"] + "',COT5='" +
                                       dr["COT5"] + "',COT6='" + dr["COT6"] + "',GHICHU='" + dr["GHICHU"] +
                ...
                bien[4] = "@KyBC";
                giatri[4] = KyBC;
                var _dt = cls.LoadDataProcPara("usp_UpKTNB01", bien, giatri, thamso);
                rpt_KTNB_01 rpt = new rpt_KTNB_01();
